(function (global, factory) {
  ...
  function safeResponseArgs() {
    ...
    return args.map(function (arg) {
      return arg instanceof Response ? arg.clone() : arg;
    });
  }
  /**
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return descriptor.payload.apply(descriptor, _toConsumableArray(safeResponseArgs(args)));
            ...
            case 16:
              ...
              _context2.next = 20;
              return descriptor.meta.apply(descriptor, _toConsumableArray(safeResponseArgs(args)));
