...
async function actionWith(descriptor, args = []) {
  try {
    descriptor.payload = typeof descriptor.payload === 'function' ? await descriptor.payload(...safeResponseArgs(args)) : descriptor.payload;
  } catch (e) {
  ...
  try {
    descriptor.meta = typeof descriptor.meta === 'function' ? await descriptor.meta(...safeResponseArgs(args)) : descriptor.meta;
  } catch (e) {
